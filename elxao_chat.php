...
#elxao-chat-<?php echo $pid;?> textarea{flex:1;resize:none;background:transparent;border:none;padding:0 52px 0 0;color:var(--chat-color);font:inherit;line-height:1.5;min-height:24px}
...
#elxao-chat-<?php echo $pid;?> .send{position:absolute;right:12px;display:inline-flex;align-items:center;justify-content:center;width:40px;height:40px;border-radius:50%;border:none;background:linear-gradient(135deg,#0ea5e9 0%,#2563eb 100%);cursor:pointer;color:#ffffff;transition:transform .2s ease,box-shadow .2s ease,filter .2s ease}
